...
class MenuBar:
    ...
    def __init__(self, main_window):
        ...
        self.new_character.setObjectName("actionNew_character")
        self.open_character = QtWidgets.QAction(main_window)
        self.open_character.setObjectName("actionOpen_character")
        self.save_character = QtWidgets.QAction(main_window)
        self.save_character.setObjectName("actionSave")
        self.exit = QtWidgets.QAction(main_window)
        self.exit.setObjectName("actionExit")
