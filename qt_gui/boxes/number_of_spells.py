...
class NumberOfSpellsBox:
    def __init__(self, centralwidget):
        self.NumberOfSpellsBox = QtWidgets.QGroupBox(centralwidget)
        ...
        qline_dict = dict(parent=self.gridLayoutWidget_10, min_size=(0, 23))
        qline_dict_2 = dict(parent=self.gridLayoutWidget_10, align=QtCore.Qt.AlignCenter)

        self.number_of_spells_0th_label = create_qlabel("number_of_spells_0th_label",
                                                        parent=self.gridLayoutWidget_10)
        ...
        self.translate_number_of_spells_box()

    def translate_number_of_spells_box(self):
