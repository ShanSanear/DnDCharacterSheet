...
class InitiativeSpeedBox:
    def __init__(self, centralwidget):
        self.InitiativeSpeedBox = QtWidgets.QGroupBox(centralwidget)
        ...
        qline_dict = dict(parent=self.gridLayoutWidget_7, min_size=(0, 23), max_size=(10000, 20))
        qlabel_dict = dict(parent=self.gridLayoutWidget_7)
        qlabel_eq_sign_dict = dict(parent=self.gridLayoutWidget_7, min_size=(8, 20), max_size=(1000, 20),
                                   align=QtCore.Qt.AlignCenter)
        qlabel_plus_sign_dict = dict(parent=self.gridLayoutWidget_7, min_size=(8, 10), max_size=(10, 10))
