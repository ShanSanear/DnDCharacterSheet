...
class AttacksBox(DefaultBox):
    def __init__(self, centralwidget):
        ...
        self.attacks_total_label = create_qlabel("attacks_total_label", **qlabel_dict)
        self.attacks_base_label = create_qlabel("attacks_base_label", **qlabel_dict)
        self.attacks_attr_mod_label = create_qlabel("attacks_attr_mod_label", **qlabel_dict)
        self.attacks_size_label = create_qlabel("attacks_size_label", **qlabel_dict)
        self.attacks_misc_label = create_qlabel("attacks_misc_label", **qlabel_dict)
        self.attacks_melee_label = create_qlabel("attacks_melee_label", **qlabel_dict)
        self.attacks_ranged_label = create_qlabel("attacks_ranged_label", **qlabel_dict)

        self.attacks_melee_total = create_qline_edit("attacks_melee_total", **qline_dict)
        self.attacks_melee_base = create_qline_edit("attacks_melee_base", **qline_dict)
        self.attacks_melee_attr_mod = create_qline_edit("attacks_melee_attr_mod", **qline_dict)
        self.attacks_melee_size = create_qline_edit("attacks_melee_size", **qline_dict)
        self.attacks_melee_misc = create_qline_edit("attacks_melee_misc", **qline_dict)
        self.attacks_ranged_total = create_qline_edit("attacks_ranged_total", **qline_dict)
        self.attacks_ranged_base = create_qline_edit("attacks_ranged_base", **qline_dict)
        self.attacks_ranged_attr_mod = create_qline_edit("attacks_ranged_attr_mod", **qline_dict)
        self.attacks_ranged_size = create_qline_edit("attacks_ranged_size", **qline_dict)
        self.attacks_ranged_misc = create_qline_edit("attacks_ranged_misc", **qline_dict)
    ...
    def set_default_values(self):
        self.attacks_melee_total.setText("10")
        self.attacks_melee_base.setText("10")
        self.attacks_melee_attr_mod.setText("10")
        self.attacks_melee_size.setText("10")
        self.attacks_melee_misc.setText("10")
        self.attacks_ranged_total.setText("10")
        self.attacks_ranged_base.setText("10")
        self.attacks_ranged_attr_mod.setText("10")
        self.attacks_ranged_size.setText("10")
        self.attacks_ranged_misc.setText("10")
