...
from qt_gui.qt_line_edits import create_qlabel, create_qline_edit, numeric_label


class SpellsPerDayBox:
    def __init__(self, centralwidget):
        self.SpellsPerDayBox = QtWidgets.QGroupBox(centralwidget)
        ...
        qline_dict = dict(parent=self.gridLayoutWidget_9, min_size=(0, 23), align=QtCore.Qt.AlignCenter)
        qlabel_dict = dict(parent=self.gridLayoutWidget_9, align=QtCore.Qt.AlignCenter)
        ...
        self.translate_spells_per_day_box()

    def translate_spells_per_day_box(self):
