...
class MainWindowUi:
    def setup_ui(self, main_window):
        ...
        self.hp_ac_box = HpAcBox(parent_for_boxes, position=[350, 220], size=[450, 150])
        ...
        self.languages_box = LanguagesBox(parent_for_boxes, position=[650, 10], size=[200, 250])
        self.feats_box = FeatsBox(parent_for_boxes, position=[650, 270], size=[200, 80])
        self.spells_per_day_box = SpellsPerDayBox(parent_for_boxes, position=[650, 370], size=[271, 350])
        self.number_of_spells_box = NumberOfSpellsBox(parent_for_boxes, position=[10, 420], size=[581, 131])
        self.known_spells_box = KnownSpellsBox(parent_for_boxes, position=[10, 550], size=[581, 101])
        ...
        self.attributes_box.root,
            ...
            self.weapons_statistics_box.root,
        ]
        children_2 = [
        ...
        for child in children_1:
            self.central_widget.tab1.layout.addChildWidget(child)

        for child in children_2:
            self.central_widget.tab2.layout.addChildWidget(child)

        for child in children_3:
            self.central_widget.tab3.layout.addChildWidget(child)
