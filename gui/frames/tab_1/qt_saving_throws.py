...
class SavingThrowsBox(DefaultBox):
    ...
    def __init__(self, parent, position, size, char_core):
        ...
        qline_dict_attr = dict(parent=self.container, min_size=(15, 23), enabled=False)
        self.fortitude_total = create_qline_edit("fortitude_total", **qline_dict)
        self.fortitude_class_base = create_qline_edit("fortitude_class_base", **qline_dict)
        self.fortitude_attr_bonus = create_qline_edit("fortitude_attr_bonus", **qline_dict_attr)
        ...
        self.reflex_total = create_qline_edit("reflex_total", **qline_dict)
        self.reflex_class_bonus = create_qline_edit("reflex_class_bonus", **qline_dict)
        self.reflex_attr_bonus = create_qline_edit("reflex_attr_bonus", **qline_dict_attr)
        ...
        self.will_total = create_qline_edit("will_total", **qline_dict)
        self.will_class_bonus = create_qline_edit("will_class_bonus", **qline_dict)
        self.will_attr_bonus = create_qline_edit("will_attr_bonus", **qline_dict_attr)
