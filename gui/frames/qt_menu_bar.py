...
class MenuBar:
    def __init__(self, main_window):
        ...
        self.open_settings = QtWidgets.QAction(main_window)
        ...
        self.file_menu.addAction(self.open_settings)
    ...
    def retranslate(self):
        ...
        self.open_settings.setText(QApplication.translate("Menu", "Settings"))
