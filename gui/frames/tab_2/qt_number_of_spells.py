...
class NumberOfSpellsBox(BoxType, DefaultBox):
    ...
    def __init__(self, parent, position, size):
        ...
        self.number_of_spells_0 = create_qline_edit(**qline_dict)
        self.number_of_spells_1 = create_qline_edit(**qline_dict)
        self.number_of_spells_2 = create_qline_edit(**qline_dict)
        self.number_of_spells_3 = create_qline_edit(**qline_dict)
        self.number_of_spells_4 = create_qline_edit(**qline_dict)
        self.number_of_spells_5 = create_qline_edit(**qline_dict)
        self.number_of_spells_6 = create_qline_edit(**qline_dict)
        self.number_of_spells_7 = create_qline_edit(**qline_dict)
        self.number_of_spells_8 = create_qline_edit(**qline_dict)
        self.number_of_spells_9 = create_qline_edit(**qline_dict)
