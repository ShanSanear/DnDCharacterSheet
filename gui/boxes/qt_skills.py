...
from gui.boxes.qt_generic_classes import DefaultBox, ResizeableBox
from gui.boxes.qt_generic_functions import create_combo_box, create_qline_edit, set_text_of_children, create_qlabel, \
